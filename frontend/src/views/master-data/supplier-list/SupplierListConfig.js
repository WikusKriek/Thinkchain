...
import {
  ...
  addData,
  filterData
} from "../../../redux/actions/supplier-list/"
import Sidebar from "./SupplierListSidebar"
...
class SupplierListConfig extends Component {
  static getDerivedStateFromProps(props, state) {
    
    if (
      props.supplierList.data.length !== state.data.length ||
      state.currentPage !== props.parsedFilter.page
    ) {
      return {
        data: props.supplierList.data,
        allData: props.supplierList.filteredData,
        totalPages: props.supplierList.totalPages,
        currentPage: parseInt(props.parsedFilter.page) - 1,
        rowsPerPage: parseInt(props.parsedFilter.perPage),
        totalRecords: props.supplierList.totalRecords,
        sortIndex: props.supplierList.sortIndex
      }
    }
