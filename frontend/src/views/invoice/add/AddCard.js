...
import Repeater from '../../../components/@vuexy/repeater/'
...
class AddCard extends React.Component {
  ...
  dueDatepicker: new Date(),
  setDueDatePicker : new Date(),
  options:{
    value: 'add-new',
  ...
  const toggleSidebar = () => setOpen(!open_)
...
var {selected,count,setCount,value,setValue,setOptions,setClients ,open_ ,setOpen,clients, setClients,selected, setSelected ,picker,setPicker,invoiceNumber,setInvoiceNumber ,dueDatepicker,setDueDatePicker,options}=this.state;
  return (
    <Fragment>
                ...
                {clients !== null ? (
                  <Fragment>
                    <Select
                      ...
                      value={value}
                      options={options}
                      theme={customizerProps.menuTheme}
                      components={{
